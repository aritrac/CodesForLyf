 ...
 * So, return false.
 *
 * Your Task:  This is a function problem. You only need to complete the function checkKthbit that takes n and k as
 * parameters and returns either true (if kth bit is set) or false(if kth bit is not set).
 *
...
public class CheckWhetherKthBitIsSet {
    public static void main(String[] args) {
        System.out.println("Is 3rd bit from LSB set for 4? " + checkKthBit(4,2));
        System.out.println("Is 4th bit from LSB set for 500? " + checkKthBit(500,3));
        System.out.println("Is 0th bit from LSB set for 4? " + checkKthBit(4,0));
    }
