 ...
 * To see how it's done, refer https://www.geeksforgeeks.org/gray-to-binary-and-binary-to-gray-conversion/.
 *
 * Example 1:
 *
 * Input: N = 7
 ...
 *
 * Your Task: The task is to complete the function greyConverter() which takes n as a parameter and returns it's
...
public class BinaryToGrayCodeConversion {
    public static void main(String[] args) {
        System.out.println("Gray code for binary 7 = " + greyConverter(7));
        System.out.println("Gray code for binary 10 = " + greyConverter(10));
    }
